    ...
    <div id="content" class="container px-2 my-5">
        <form id="new-game-form" class="container-fluid row p-5" method="POST" enctype="multipart/form-data">
            <div id="img-container" class="col-10 col-md-3 col-lg-2">
                <p class="fs-4 text-center user-select-none">Press to select file</p>
            ...
            <div class="container-fluid col-12 col-md-9 col-lg-10">
                <div class="flex-fill row justify-content-between mx-auto">
                    <div class="col-6 col-lg-5 px-0">
                        <input id="new-game-name" name="name" type="text" class="form-control fs-4" placeholder="Title">
                    </div>
                    <div class="col-3 col-lg-2 d-flex px-0">
                        <input id="new-game-price" name="price" type="text" class="form-control fs-4"
                               placeholder="Price">
                        <div class="align-self-center d-block my-0 ms-3 fs-4">kzt</div>
                    </div>
                </div>
                <div class="flex-fill">
                    <textarea id="new-game-description" name="desc" class="container-fluid form-control my-4 fs-5"
                              placeholder="Start typing your description there..."></textarea>
                </div>
                ...
                <div class="col-12 d-flex gap-2 align-items-center fs-4">
                    ...
                    <div class="col-3 col-md-2">
                        <input id="new-game-quantity" name="count" type="text" class="form-control col-3 fs-4">
                    </div>
