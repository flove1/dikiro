            ...
            <div class="container-fluid col-12 col-md-9 col-lg-10">
                <div class="flex-fill row justify-content-between mx-auto">
                    ...
                    <div class="col-3 col-lg-2 d-flex px-0">
                        <input id="new-game-price" name="price" type="number" class="form-control fs-4 rounded" placeholder="Price..." @isset($item)value="{{ $item->price }}"@endisset required/>
                ...
                <div id="new-game-tags" class="flex-fill gap-2 row mb-4 fs-4">
                    <div>Tags:</div>
                        ...
                        <div class="tag col @isset($item) @if ($item->tags()->where('tag', '=', 'Roleplay')->count() == 1) tag-active @endif @endisset">Roleplay</div>
                ...
                <div class="col-12 d-flex gap-2 align-items-center fs-4">
                    ...
                    <div class="col-3 col-md-2">
                        <input id="new-game-quantity" name="count" type="number" class="form-control col-3 fs-4 rounded" placeholder="Count..." @isset($item)value="{{ $item->count }}"@endisset required/>
                    </div>
